    ...
    var Tt = it.extend({
        ...
        calculateBarValuePixels: function (t, e, n) {
          var i,
            ...
            x =
              void 0 === p.start ? 0 : p.max >= 0 && p.min >= 0 ? p.min : p.max,
            y =
              void 0 === p.start
                ? p.end
                : p.max >= 0 && p.min >= 0
        ...
        !s._isVisible() || !u.display || h >= c || d <= 1 || !s.isHorizontal()
          ...
          : ((e = (t = s._getLabelSizes()).widest.width),
            ...
            e + 6 > (a = l.offset ? s.maxWidth / d : i / (d - 1)) &&
              ...
              (r =
                s.maxHeight - fn(l.gridLines) - u.padding - gn(l.scaleLabel)),
              (o = Math.sqrt(e * e + n * n)),
              (f = H.toDegrees(
                Math.min(
        ...
        if (
          ...
          if (u) {
            var b = 0 !== t.labelRotation,
              ...
              _ = Math.sin(x),
              k =
                _ * g.width + y * (p.height - (b ? p.offset : 0)) + (b ? 0 : m);
